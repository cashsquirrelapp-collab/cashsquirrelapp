...
export function routeHandler(route:string):Handler {
 ...
 },{csrf:['auth','data','groups','profile','admin-users','line-link-code','password-reset-line','notify'].includes(route)});
}
